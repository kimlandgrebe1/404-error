...
# Her starter min kode
    ...
    def handleLogin(self):
        ...
        try:
            ...
            usernames = [username[0].replace("'", "") for username in result_Username] #looper gennem brugernavnene, fjerner "'" og gemmer dem i usernames variablen
        ...
        try:
            ...
            passwords = [password[0].replace("'", "") for password in result_Password] #samme som ved brugernavne
